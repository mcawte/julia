...
dup(x::RawFD) = RawFD(ccall((@static iswindows() ? :_dup : :dup), Int32, (Int32,), x.fd))
dup(src::RawFD, target::RawFD) = systemerror("dup", -1 ==
    ccall((@static iswindows() ? :_dup2 : :dup2), Int32,
...
function FILE(fd::RawFD, mode)
    FILEp = ccall((@static iswindows() ? :_fdopen : :fdopen), Ptr{Void}, (Cint, Cstring), fd, mode)
